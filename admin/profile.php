                  ...
                  <div class="col-sm-12 col-md-8">
                     ...
                     <div class="review-block">
                        <div class="row">
                           <div class="col-sm-3">
                              <div class="review-block-img">
                                 <img src="../assets/assets/dist/img/avatar.png" class="img-rounded" alt="">
                              </div>
                        ...
                        <div class="row">
                           <div class="col-sm-3">
                              <div class="review-block-img">
                                 <img src="../assets/assets/dist/img/avatar2.png" class="img-rounded" alt="">
                              </div>
                              <div class="review-block-name"><a href="#">nktailor</a></div>
                              <div class="review-block-date">January 29, 2016<br/>1 day ago</div>
                           </div>
                        ...
                        <div class="row">
                           <div class="col-sm-3">
                              <div class="review-block-img">
                                 <img src="../assets/assets/dist/img/avatar3.png" class="img-rounded" alt="">
                              </div>
                              <div class="review-block-name"><a href="#">nktailor</a></div>
                              <div class="review-block-date">January 29, 2016<br/>1 day ago</div>
                           </div>
